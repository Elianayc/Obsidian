El **TCP** (Protocolo de Control de Transmisión) es un estándar de comunicación que permite a los dispositivos y aplicaciones intercambiar datos de forma segura y ordenada a través de una red como Internet.
...
- **TCP:** Se encarga de organizar, ordenar y asegurar que los datos lleguen completos.
- **IP (Protocolo de Internet):** Se encarga de poner la dirección correcta en cada paquete para que encuentre el camino al dispositivo de destino.
