...
---
Proceso de análisis y organización de los datos de un sistema para definir su estructura, relaciones y documentación.
Permite establecer cómo se representan, almacenan y gestionan los datos necesarios para el funcionamiento del sistema.
