...
- Representan necesidades desde la perspectiva del usuario.
- Facilitan la comunicación entre negocio y desarrollo.
- Permiten dividir funcionalidades grandes en entregas pequeñas.
- Facilitan la estimación y planificación.
- Se adaptan a cambios en las necesidades del negocio.
