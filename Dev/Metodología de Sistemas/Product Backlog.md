...
---
El **Product Backlog** es una **lista ordenada y priorizada de todo el trabajo necesario para desarrollar y mejorar un producto**.
...
- Es **dinámico** y se actualiza continuamente.
- Contiene las necesidades y trabajos pendientes del producto.
- Sus elementos se **ordenan según prioridad**.
- Evoluciona a medida que aumenta el conocimiento del negocio y del equipo.
- Sirve como base para seleccionar el trabajo de los **Sprints**.
...
Estas historias pueden incorporarse al **Product Backlog** y distribuirse en diferentes **Sprints**.
