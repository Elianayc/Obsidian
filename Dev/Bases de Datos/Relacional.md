...
- [[Entidad]] → objeto del mundo real identificable de forma única.
- [[Relación]] → asociación entre entidades.

Permite modelar cómo se organizan los datos antes de implementarlos en una base de datos relacional.
