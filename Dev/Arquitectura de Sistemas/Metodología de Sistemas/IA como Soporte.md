La **Inteligencia Artificial (IA)** puede utilizarse como herramienta de apoyo durante la gestión de Requerimientos, la elaboración de Historias de Usuario, la definición de Criterios de Aceptación, testing y la documentación de un proyecto de software.
