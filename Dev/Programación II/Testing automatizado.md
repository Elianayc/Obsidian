...
- Facilita el refactoring (cambios en el código sin romper funcionalidad).
- Permite trabajo en equipo con mayor confianza en el sistema.
- Ayuda a detectar acoplamientos y reduce el costo de cambios.
