...
Fue creado bajo la especificación de la **W3C ([[World Wide Web (WWW)]] Consortium)** y permite que los navegadores interpreten una estructura formada por identificadores llamados **etiquetas (tags)** para generar un documento web.
